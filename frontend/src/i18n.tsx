...
const ES: Record<string, string> = {
  ...
  "Select-type column": "Columna de tipo select",
  "{count} available": "{count} disponibles",
  "No select columns available.": "No hay columnas de tipo select disponibles.",
  "Source table: {table}": "Tabla fuente: {table}",
  "The selected select column defines the pipeline columns.": "La columna select elegida define las columnas del pipeline.",
  "Card settings": "Ajustes de tarjeta",
  "Title column": "Columna titulo",
  "Custom fields": "Campos personalizados",
  "Fields": "Campos",
  "Add field": "Anadir campo",
  "No more fields": "No hay mas campos",
  "No editable fields configured yet.": "Aun no hay campos editables configurados.",
  "Click for settings": "Click para ajustes",
  "Drag to reorder": "Arrastrar para reordenar",
  "Title field": "Campo titulo",
